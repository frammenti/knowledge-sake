...
write.csv(data_1, "../datasets/source/D1.1_PISA_scores_vs_escs_00_09.csv", row.names = TRUE)
write.csv(data_2, "../datasets/source/D1.2_PISA_scores_vs_escs_12_22.csv", row.names = TRUE)
